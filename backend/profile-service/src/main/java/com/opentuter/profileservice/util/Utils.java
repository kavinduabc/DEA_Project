...
public class Utils {
    ...
    public static final String VIEW_USER_BY_ID_URL = "/view/{id}";
    ...
    public static final String ACCESS_URL_REGISTER = "/api/v1/user/reg";
    public static final String ACCESS_URL_LOGIN = "/api/v1/user/login";
