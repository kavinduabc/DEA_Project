...
import com.opentuter.assignmentservice.dto.GradeRequestDTO;
...
public class AssignmentController {
    ...
    public ResponseEntity<SubmissionResponseDTO> gradeSubmission(@PathVariable UUID id,
        ...
        return ResponseEntity.ok(assignmentService.gradeSubmission(id, request.getGrade(), request.getFeedback()));
    }
