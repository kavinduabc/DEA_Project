...
//   // Holds classroom found via GET /api/classrooms/verify/{inviteCode}
//   const [verifiedClassrooms, setVerifiedClassrooms] = useState<Classroom[]>([])
//   const [verifyError, setVerifyError] = useState('')

//   // TODO: Replace with classrooms the student is enrolled in (from Enrollment Service)
...
//     // On success, setVerifiedClassrooms(data)
//     // On empty, setVerifyError('No classroom found with this invite code.')
//     setVerifyError('') // reset
//     setVerifiedClassrooms([]) // reset
//   }

//   // After verifying, student joins — handled by Enrollment Service (out of scope here)
//   const handleJoinClass = (classroomId: number) => {
//     console.log('Join classroom:', classroomId)
...
//               {/* Join by Invite Code — GET /api/classrooms/verify/{inviteCode} */}
...
//         {/* Enrolled Classrooms — GET /api/classrooms/{id} per enrolled class */}
